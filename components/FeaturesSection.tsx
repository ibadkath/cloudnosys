...
export default function FeaturesSection() {
  return (
    <section className=" bg-white flex flex-col pt-20 md:pt-36 pb-4 px-4 md:px-16" style={{ borderRadius: 30 }}>
      ...
      <motion.h2
        className="HeroHeading text-center mx-auto max-w-[89%] sm:max-w-[70%] tb:max-w-max"
        style={{ fontWeight: 500, color: '#060606' }}
      ...
      <motion.p
        ...
        style={{ color: '#060606', maxWidth: 700, margin: '16px auto 0' }}
        initial={{ opacity: 0, y: 18 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.2 }}
      ...
      <motion.div
        className="features-row1 flex flex-col md:flex-row gap-4 md:gap-5 mt-8 md:mt-14 w-full"
      ...
      >
        ...
        {/* Card 1 */}
        <motion.div
          className="feature-card-tb md:flex-1 h-[240px] md:h-[308px] rounded-xl bg-[#070707] overflow-hidden flex flex-col"
          whileHover={{ y: -6 }}
        ...
        <motion.div
          className="feature-card-tb md:hidden h-[240px] rounded-xl bg-[#070707] overflow-hidden flex flex-col"
          whileHover={{ y: -6 }}
          transition={{ duration: 0.25, ease: "easeOut" }}
        >
      ...
      <motion.div
        className="flex flex-col md:flex-row gap-4 md:gap-5 mt-4 md:mt-5 w-full"
        initial={{ opacity: 0, y: 28 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.15 }}
      ...
      >
        ...
        {/* Card 4 — desktop only */}
        <motion.div
          className="hidden md:flex h-[350px] rounded-xl bg-[#070707] overflow-hidden flex-col"
          style={{ flex: '602 602 0' }}
          whileHover={{ y: -6 }}
          transition={{ duration: 0.25, ease: "easeOut" }}
        >
        ...
        {/* Card 5 */}
        <motion.div
          className="feature-card-tb-wide h-[280px] md:h-[350px] md:flex-[706_706_0] rounded-xl bg-[#070707] overflow-hidden flex flex-col"
          whileHover={{ y: -6 }}
          transition={{ duration: 0.25, ease: "easeOut" }}
        >
